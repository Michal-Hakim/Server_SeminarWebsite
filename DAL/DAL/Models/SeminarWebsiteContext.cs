...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AttendenceCodeForTheCourse).HasName("PK__Attenden__D10AD1089C36DD47");
        ...
        {
            entity.HasKey(e => e.CourseCode).HasName("PK__Courses___FC00E001A14C6B3A");
        ...
        {
            entity.HasKey(e => e.LessonCode).HasName("PK__ExistedL__F447E50481EBB2DF");
        ...
        {
            entity.HasKey(e => e.CourseCodeForTheMajor).HasName("PK__MajorCou__FD811A27613880A5");
        ...
        {
            entity.HasKey(e => e.MajorCode).HasName("PK__Major_tb__64E58F959F925873");

            entity.ToTable("Major_tbl");

            entity.Property(e => e.MajorName).HasMaxLength(15);
        ...
        {
            entity.HasKey(e => e.MarkCodeForTheCourse).HasName("PK__MarkPerC__EDE971E6388FC3C4");
            ...
            entity.HasOne(d => d.CourseCodeForTheMajorNavigation).WithMany(p => p.MarkPerCourseTbls)
                .HasForeignKey(d => d.CourseCodeForTheMajor)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__MarkPerCo__Cours__5070F446");

            entity.HasOne(d => d.StudentCodeNavigation).WithMany(p => p.MarkPerCourseTbls)
                .HasForeignKey(d => d.StudentCode)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__MarkPerCo__Stude__5165187F");
        });

        modelBuilder.Entity<SeminarTbl>(entity =>
        {
            entity.HasKey(e => e.SeminarCode).HasName("PK__Seminar___FB52B63E9B2B9CD1");

            entity.ToTable("Seminar_tbl");

            entity.Property(e => e.SeminarAddress).HasMaxLength(50);
            ...
            entity.Property(e => e.SeminarFaxNumber)
                .HasMaxLength(10)
                .IsUnicode(false);
            entity.Property(e => e.SeminarLocationCity).HasMaxLength(50);
            entity.Property(e => e.SeminarManagerPassword)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.SeminarName).HasMaxLength(50);
        ...
        {
            entity.HasKey(e => e.StaffCode).HasName("PK__Staff_tb__D83AD813F5788E0A");
            ...
            entity.Property(e => e.StaffMemberPosition).HasMaxLength(50);
        ...
        {
            entity.HasKey(e => e.StudentCode).HasName("PK__Students__1FC8860554CCA555");
            ...
            entity.HasOne(d => d.SeminarCodeNavigation).WithMany(p => p.StudentsTbls)
                .HasForeignKey(d => d.SeminarCode)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Students___Semin__46E78A0C");
            ...
            entity.HasOne(d => d.StudentFirstMajorCodeNavigation).WithMany(p => p.StudentsTblStudentFirstMajorCodeNavigations)
                ...
                .HasConstraintName("FK__Students___Stude__440B1D61");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User_tbl__1788CCACDDE91986");
            ...
            entity.Property(e => e.UserFirstName).HasMaxLength(10);
            entity.Property(e => e.UserHebrewDateOfBirth).HasMaxLength(9);
            entity.Property(e => e.UserHomePhoneNumber)
                .HasMaxLength(10)
                .IsUnicode(false);
            entity.Property(e => e.UserLastName).HasMaxLength(10);
            entity.Property(e => e.UserLocationCity).HasMaxLength(50);
